...
hi IncSearch       guifg=#ff0000    guibg=#FFFFFF    ctermfg=black    ctermbg=white    gui=ITALIC       cterm=ITALIC
hi Search          guifg=#000000    guibg=#FFFFFF    ctermfg=black    ctermbg=white    gui=NONE         cterm=NONE
...
hi DiffChange      guifg=#A0A0A0    guibg=#5f0087    ctermfg=grey     ctermbg=black    gui=NONE         cterm=NONE
hi DiffDelete      guifg=#A0A0A0    guibg=#5f0087    ctermfg=grey     ctermbg=black    gui=NONE         cterm=NONE
hi DiffText        guifg=#A0A0A0    guibg=#af0000    ctermfg=grey     ctermbg=black    gui=NONE         cterm=NONE
...
hi StatusLine      guifg=#A0A0A0    guibg=#3a3a3a    ctermfg=grey     ctermbg=black    gui=bold         cterm=bold
hi StatusLineNC    guifg=#A0A0A0    guibg=#121212    ctermfg=grey     ctermbg=black    gui=ITALIC       cterm=ITALIC
...
hi VertSplit       guifg=#ffffff    guibg=#000000    ctermfg=grey      ctermbg=red      gui=NONE         cterm=NONE
...
hi DiffAdd         guifg=#FFFFFF    guibg=#5f0087    ctermfg=white    ctermbg=black    gui=NONE         cterm=NONE
